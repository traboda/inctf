...
const MissionSection = ({ title, children, className = "", isFirst, isLast }: { title: string, children: React.ReactNode, className?: string, isFirst?: boolean, isLast?: boolean }) => (
    ...
    >
        ...
        <div className="relative filter drop-shadow-[0_0_10px_rgba(56,189,248,0.5)] w-full">

            {/* The Card Shape */}
            <div
                className="relative p-[2px] bg-gradient-to-r from-sky-digital/80 via-sky-digital/40 to-sky-digital/80 w-full"
                style={{
...
const MissionControlPageContent = () => {
    ...
    return (
        <AppThemeWrapper id="mission-control-page">
            <div ref={containerRef} className="relative w-full font-mono selection:bg-sky-digital/30">
                ...
                {/* Content Container */}
                <div className="relative z-10 pt-32 pb-40 px-4 container mx-auto max-w-5xl w-full">
...
export default MissionControlPageContent;
