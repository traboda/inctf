...
import { AdvisoryBoard, AdvisoryBoardAlumni } from '../../data/organizers';
...
const AdvisoryBoardContent = () => {
    ...
    return (
        <AppThemeWrapper id="advisory-board-page">
            ...
            <div className="w-full relative z-10 py-12 px-2">
                {AdvisoryBoard?.length > 0 && (
                    <div className="py-8 container mx-auto">
                        ...
                        <div className="flex flex-wrap">
                            {AdvisoryBoard.map((a: any, i: number) => (
                ...
                {AdvisoryBoardAlumni?.length > 0 && (
                    <div className="py-8 container mx-auto">
                        ...
                        <div className="flex flex-wrap">
                            {AdvisoryBoardAlumni.map((a: any, i: number) => (
                                <div className="w-full sm:w-1/2 md:w-1/3 lg:w-1/4 py-3 sm:p-3" key={i}>
                                    <ProfileCard {...a} />
                                </div>
                            ))}
