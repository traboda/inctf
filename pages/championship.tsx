...
const ChampionshipPage = () => {
  return (
    <SiteView meta={{ title: 'Championship | InCTF Jr' }}>
        ...
        <main className="relative z-10 pt-24 pb-20">
          <div className="container mx-auto px-4 text-center mb-10">
            <h1 className="text-4xl md:text-6xl font-black text-white mb-4 uppercase tracking-tighter">
              <GlitchText text="CHAMPIONSHIP ARENA" />
            </h1>
            <div className="w-24 h-1 bg-gradient-to-r from-transparent via-sky-500 to-transparent mx-auto mb-6"></div>
            <p className="text-sky-400 font-mono uppercase tracking-widest text-sm mb-12">
                            // ELITE OPERATIONS & REWARDS
            </p>
          </div>

          <div id="why-participate" className="scroll-mt-24">
